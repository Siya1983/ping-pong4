...
if(error){
  ...
  console.log(results);
  rightWristX= results[0].pose.keypoints[9].rightWrist.x;
  rightWristY= results[0].pose.keypoints[10].rightWrist.y;
scoreRightWrist= results[0].pose.keypoints[9].rightWrist;
}
}
